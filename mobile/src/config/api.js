...
export const ENDPOINTS = {
  ...
  pendingRepayments:   `${V1}/people/pending-repayments`,
  sentRepayments:      `${V1}/people/sent-repayments`,
  acceptRepayment:     (id) => `${V1}/people/repayments/${id}/accept`,
  rejectRepayment:     (id) => `${V1}/people/repayments/${id}/reject`,
  cancelRepayment:     (id) => `${V1}/people/repayments/${id}`,
  pendingSettlements:  `${V1}/people/pending-settlements`,
  sentSettlements:     `${V1}/people/sent-settlements`,
  acceptSettlement:    (id) => `${V1}/people/settlements/${id}/accept`,
  rejectSettlement:    (id) => `${V1}/people/settlements/${id}/reject`,
  cancelSettlement:    (id) => `${V1}/people/settlements/${id}`,
