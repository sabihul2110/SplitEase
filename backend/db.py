...
# ─────────────────────────────────────────────
#  SETTLEMENTS -> MOVED TO settlement_repository.py
# ─────────────────────────────────────────────
from repositories.settlement_repository import (
    calculate_settlements, simplify_debts, fetch_settlements_for_groups
)
...
# ─────────────────────────────────────────────
#  LOANS -> MOVED TO loan_repository.py
# ─────────────────────────────────────────────
from repositories.loan_repository import (
    fetch_loans, insert_loan, record_loan_repayment, delete_loan
)
...
#     """
#     Returns groups where user has non-zero net balance.
#     Used to warn before reset.
#     """
#     conn = get_connection()
#     cur  = conn.cursor(dictionary=True)
#     cur.execute("""
